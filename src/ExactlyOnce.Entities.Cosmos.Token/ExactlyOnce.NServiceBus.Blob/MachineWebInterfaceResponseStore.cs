...
{
    public class MachineWebInterfaceResponseStore : IMachineWebInterfaceResponseStore
    {
        readonly BlobContainerClient containerClient;
        readonly string prefix;

        public MachineWebInterfaceResponseStore(BlobContainerClient containerClient, string prefix)
        {
